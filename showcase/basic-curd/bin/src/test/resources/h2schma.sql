...
create table tb_data_dictionary (id varchar(32) not null, name varchar(256) not null, remark varchar(512), type varchar(1) not null, value varchar(32) not null, fk_category_id char(32) not null, primary key (id))
create table tb_dictionary_category (id varchar(32) not null, code varchar(128) not null, name varchar(256) not null, remark varchar(512), fk_parent_id char(32), primary key (id))
