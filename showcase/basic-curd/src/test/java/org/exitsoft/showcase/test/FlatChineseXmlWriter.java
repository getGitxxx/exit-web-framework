...
public class FlatChineseXmlWriter  implements IDataSetConsumer{

	 /**
     * Logger for this class
     */
    private static final Logger logger = LoggerFactory.getLogger(FlatChineseXmlWriter.class);

    private static final String DATASET = "dataset";

    private ChineseXmlWriter _xmlWriter;
    private ITableMetaData _activeMetaData;
    private int _activeRowCount;
    private boolean _includeEmptyTable = false;
    private String _systemId = null;

    public FlatChineseXmlWriter(OutputStream out) throws IOException
    {
        this(out, null);
    }
     ...
     */
    public FlatChineseXmlWriter(OutputStream outputStream, String encoding) 
    throws UnsupportedEncodingException
    {
        _xmlWriter = new ChineseXmlWriter(outputStream, encoding);
        _xmlWriter.enablePrettyPrint(true);
    }

    public FlatChineseXmlWriter(Writer writer)
    {
        _xmlWriter = new ChineseXmlWriter(writer);
        _xmlWriter.enablePrettyPrint(true);
    }

    public FlatChineseXmlWriter(Writer writer, String encoding)
    {
        _xmlWriter = new ChineseXmlWriter(writer, encoding);
        _xmlWriter.enablePrettyPrint(true);
    }
