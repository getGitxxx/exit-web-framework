...
create table TB_RESOURCE (id varchar(32) not null, permission varchar(64), remark varchar(512), sort bigint not null, name varchar(32) not null, type varchar(2) not null, value varchar(256), fk_parent_id varchar(32), icon varchar(32), leaf boolean, primary key (id));
