...
create table TB_USER_AUD (id varchar(32) not null, rev integer not null, revtype tinyint, email varchar(128), password varchar(32), portrait varchar(256), realname varchar(64), state integer, username varchar(32), primary key (id, rev));
create table TB_GROUP_AUD (id varchar(32) not null, rev integer not null, revtype tinyint, name varchar(32), remark varchar(512), role varchar(64), state integer, type varchar(2), value varchar(256), fk_parent_id varchar(32), primary key (id, rev));
create table TB_RESOURCE_AUD (id varchar(32) not null, rev integer not null, revtype tinyint, icon varchar(32), leaf boolean, name varchar(32), permission varchar(64), remark varchar(512), sort bigint, type varchar(2), value varchar(256), fk_parent_id varchar(32), primary key (id, rev));
...
alter table TB_USER_AUD add constraint FK_lls5cx43tqbwx5qin1iw82led foreign key (rev) references REVINFO;
alter table TB_RESOURCE_AUD add constraint FK_qsu90aemkr4aq0ee6hx8424k6 foreign key (rev) references REVINFO;
alter table TB_GROUP_AUD add constraint FK_fvg1b3ji49c6l2v1y8j7qd5xf foreign key (rev) references REVINFO;
