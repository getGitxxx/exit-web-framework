...
<head>
    ...
    <script type="text/javascript" src="resource/script/jquery-1.10.2.min.js"></script>
						...
						<div class="content-widget" id="content-widget">
							<div class="server-error"> 
					    		...
					    		<p>
									...
									<a class="btn btn-danger" href="mailto:es.chenxiaobo@gamil.com">
