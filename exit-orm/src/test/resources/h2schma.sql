...
alter table tb_account_menu_aud drop constraint FK_7cllsl67e00sc0snygv0sei5g
alter table tb_account_role_aud drop constraint FK_f4ia4t8i9noa1h8lvjid3ghys
...
drop table tb_account_menu_aud if exists
drop table tb_account_role if exists
drop table tb_account_role_aud if exists
...
create table tb_account_menu_aud (id varchar(32) not null, rev integer not null, revtype tinyint, name varchar(255), type integer, fk_parent_id varchar(32), primary key (id, rev))
create table tb_account_role (id varchar(32) not null, name varchar(255), primary key (id))
create table tb_account_role_aud (id varchar(32) not null, rev integer not null, revtype tinyint, name varchar(255), primary key (id, rev))
...
alter table tb_account_menu_aud add constraint FK_7cllsl67e00sc0snygv0sei5g foreign key (rev) references revinfo
alter table tb_account_role_aud add constraint FK_f4ia4t8i9noa1h8lvjid3ghys foreign key (rev) references revinfo
